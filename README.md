...
- [Preparation](#preparation)
  * [Creating a catkin workspace](#creating-a-catkin-workspace)
  * [Create a package](#create-a-package)
  * [Allow ROS to recognize new package](#allow-ros-to-recognize-new-package)
- [Node Introduction](#node-introduction)
  * [What is a node?](#what-is-a-node-)
  * [Code](#code)
  * [Run](#run)
  * [Check running node](#check-running-node)
...
- Modify Package/CMakeList.txt:
    ...
    ```
    - catkin builds on top of cmake.
    - add dependencies for the executable targets to message generation targets. **?**
...
- Under src directory of package:
    - For C++:
        ...
        - `ros::init(argc, argv, "node_name")`
            ...
            - Provide argc and argv so that it can **perform any ROS arguments and name remapping** that were provided at the command line. **?**
        - `ros::NodeHandle n;` **?**
...
## Check running node
- `rosnode list`
    - extract the node name that is defined in init_node()
...
- `std_msgs::String msg` and `msg.data = ss.str()`
    ...
    - broadcast message using message-adapted class, String, generally **generated from a msg file**. **?**
- `chatter_pub.public(msg)`
    - `publish()` function send messages
        - Parameter: the message object
        - The type of this object must **agree with the type** given as a template parameter to the advertise<>() call. (Eg: `std_msgs::String)`
...
- `ros::spinOne()` **?**
    ...
    - Not neccesary if not recieving callbacks.
